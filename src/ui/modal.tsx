...
export const Modal = React.forwardRef(
  (
    ...
    const renderHandleComponent = React.useCallback(
      () => (
        <>
          <View className="mb-4 mt-2 h-1 w-12 self-center rounded-lg bg-gray-400 dark:bg-gray-700" />
    ...
    return (
      <BottomSheetModal
        ...
        backgroundStyle={{
          backgroundColor: colorScheme === 'dark' ? colors.charcoal[850] : '#fff',
        }}
        {...props}
        {...detachedProps}
        ref={modal.ref}
...
const ModalHeader = React.memo(({title, dismiss, showCloseButton}: ModalHeaderProps) => {
  return (
    <>
      {title && (
