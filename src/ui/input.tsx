...
const inputTv = tv({
  slots: {
    ...
    inputWrapper:
      'mt-0 flex-row items-center gap-2 rounded-lg border-[0.5px] border-neutral-400 bg-neutral-100 px-4  dark:border-neutral-700 dark:bg-neutral-800',
  ...
  variants: {
    focused: {
      true: {
        input: 'border-neutral-400 dark:border-neutral-200',
      },
    },
    error: {
      true: {
